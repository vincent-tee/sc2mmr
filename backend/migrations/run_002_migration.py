...
def run_migration():
    ...
    with engine.connect() as connection:
        try:
            connection.execute(text("ALTER TABLE player_match_metrics ADD COLUMN team_fight_participation REAL DEFAULT 0.0"))
        ...
        try:
            connection.execute(text("ALTER TABLE player_match_metrics ADD COLUMN team_fight_damage INTEGER DEFAULT 0"))
        ...
        try:
            connection.execute(text("ALTER TABLE player_match_metrics ADD COLUMN team_fight_damage_ratio REAL DEFAULT 0.0"))

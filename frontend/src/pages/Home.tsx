...
import { FiUpload, FiZap, FiTarget, FiActivity, FiArrowRight, FiAward } from 'react-icons/fi';
import { LuCrown } from 'react-icons/lu';
import { useNavigate } from 'react-router-dom';
import { useQuery } from '@tanstack/react-query';
import { playersApi, replaysApi } from '../api/endpoints';
import RankBadge from '../components/RankBadge';
import { formatDateOnly, getPlayerAvatarUrl, getPlayerRaces, getRaceColor } from '../utils/formatting';
          ...
          <GridItem colSpan={{ base: 12, lg: 5 }}>
            ...
            <VStack spacing={2} align="stretch" mt={6}>
              {[
                ...
                { label: 'Squad meta report', icon: FiActivity, path: '/meta' },

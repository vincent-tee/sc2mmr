...
const TacticalCard: React.FC<TacticalCardProps> = ({
  ...
  const bgColor = useColorModeValue('white', 'rgba(60, 52, 40, 0.9)');
  const borderColor = useColorModeValue('gray.200', 'rgba(255, 140, 26, 0.3)');

  const variants: Record<TacticalCardVariant, VariantStyle> = {
    default: {
  ...
  return (
    <Box
      ...
      _hover={onClick ? {
        ...
        boxShadow: `0 8px 30px rgba(255, 140, 26, 0.4), 0 0 20px ${glowColor}`,
        _before: {
          opacity: 1,
        },
      } : {}}

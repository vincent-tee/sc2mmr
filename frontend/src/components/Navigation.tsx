...
const Navigation: React.FC = () => {
  ...
  // Fetch recent matches for potential MMR ticker feature
  useQuery({
    queryKey: ['recent-matches-ticker'],
    queryFn: async () => {
      const response = await replaysApi.getMatches(5);
  ...
  const navItems: NavItem[] = [
    ...
    { path: '/predictor', label: 'Predict Lineup', icon: FiTarget },
              ...
              return (
                <Button
                  ...
                  _before={active ? {
                    ...
                    right: '-2px',
                    bottom: '-2px',
                    background: 'linear-gradient(45deg, transparent, rgba(255, 140, 26, 0.3), transparent)',
                    borderRadius: 'md',
                    zIndex: -1,
                  } : {}}
                >
